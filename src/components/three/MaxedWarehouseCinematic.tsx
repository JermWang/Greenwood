 ...
 *
 * Slow enough that a recording of this page yields usable stills, which is what
 * scripts/build-cinematic-stills.mjs cuts the blurred app backdrop from. At the
 * original 18s the camera crossed roughly a sixth of the warehouse between captured
 * frames, leaving them smeared and too far apart to pick a clean set out of.
 */
