        ...
        return (
          <group key={p.wallet}>
            {/* Positions arrive a few times a second, and Character walks toward
                ...
                crossing the wire. */}
            <Character look={look} target={{ x: p.x, z: p.z }} />
            ...
            <mesh position={[p.x, 0.016, p.z]} rotation={[-Math.PI / 2, 0, 0]} raycast={() => null}>
              ...
              <meshBasicMaterial color={ISO.accent} transparent opacity={0.5} toneMapped={false} depthWrite={false} />
            </mesh>
            ...
            <mesh position={[p.x, 0.9, p.z]} onClick={(e) => hit(e, p.wallet)}>
